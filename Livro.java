...
public class Livro implements ActionListener
{
    ...
    public void excluir(){
        if(JOptionPane.showConfirmDialog(null,"Confirmação", "Deseja realmente apagar este livro?",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION){
            if(this.apaga()){
